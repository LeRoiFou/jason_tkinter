...
Il existe 3 méthodes de positionnement de widgets :
    ...
    fenêtre est une grille de 400 pixels x 300 pixels
    -> la méthode place()
...
label.grid(row=0, column=0)  # Affichage du label à 0 pixel en ligne et 0 pixel en colonne
ent.grid(row=0, column=1)  # Affichage du champ de saisies à 0 pixel en ligne et 1 pixel en colonne
btn.grid(row=0, column=2)  # Affichage du bouton à 0 pixel en ligne et 2 pixels en colonne
